...
impl ApiConvert<DataReceive> for DepthMarketDataField {
    fn api_convert(self) -> DataReceive {
        TickData {
            ...
            open: self.OpenPrice as f32,
            high: self.HighestPrice as f32,
            low: self.LowestPrice as f32,
            close: self.ClosePrice as f32,
            pre_close: self.PreClosePrice as f32,
            open_interest: self.OpenInterest as f32,
            volume: self.Volume as f32,
            amount: self.Turnover as f32,
