    ...
    fn idx_out(&self, idx: Idx) -> Self {
        match idx {
            Idx::Range(r) => PriceTick {
                ...
                pre_close: self.pre_close[r.clone()].to_vec(),
                open_interest: self.open_interest[r.clone()].to_vec(),
                ...
                ask_volume1: self.ask_volume1[r.clone()].to_vec(),
            ...
            Idx::List(v) => PriceTick {
                ...
                open: self.open.get_list_index(&v),
                high: self.high.get_list_index(&v),
                low: self.low.get_list_index(&v),
                close: self.close.get_list_index(&v),
                pre_close: self.pre_close.get_list_index(&v),
                open_interest: self.open_interest.get_list_index(&v),
                volume: self.volume.get_list_index(&v),
                amount: self.amount.get_list_index(&v),
